      ...
      <div className='bg-white py-6 md:py-8'>
        <div className='mx-auto w-full md:max-w-screen-2xl pt-20 px-4 md:px-8'>
          ...
          <p className=' mx-auto mb-6 max-w-screen-md text-2xl font-bold text-center text-black '>
            ...
            <p className='hidden md:flex mx-auto max-w-screen-md text-sm text-center text-gray-500 '>
  Unearth a world of exquisite vegetables on our platform. Delve into a rich tapestry of root crops sourced from dedicated farmers and vendors across Niger State. Embark on a journey to cultivate a flourishing tuber marketplace and champion sustainable agriculture. Discover more.
</p>
            </p>

            <p className=' md:hidden mx-auto max-w-screen-md text-sm text-center text-gray-500 '>
 Unearth a world of exquisite vegetables on our platform. </p>
          </div>
          {/* text - end */}
